...
namespace systems::leal::vector_math {
    ...
    public:
        ...
        ///
        /// x86: 256-bit multiply followed by two horizontal adds.
        ...
        static inline Vector4d min(const Vector4d& a, const Vector4d& b) {
                ...
                Vector4d result;
                _mm256_store_pd(result.data,
                    _mm256_min_pd(_mm256_load_pd(a.data), _mm256_load_pd(b.data)));
                return result;
            #elif defined(__VECTOR_MATH_ARCH_ARM) && (defined(__arm64__) || defined(__aarch64__))
                Vector4d result;
        ...
        static inline Vector4d max(const Vector4d& a, const Vector4d& b) {
                ...
                Vector4d result;
                _mm256_store_pd(result.data,
                    _mm256_max_pd(_mm256_load_pd(a.data), _mm256_load_pd(b.data)));
                return result;
            #elif defined(__VECTOR_MATH_ARCH_ARM) && (defined(__arm64__) || defined(__aarch64__))
                Vector4d result;
        ...
        static inline Vector4d lerp(const Vector4d& a, const Vector4d& b, double t) {
                ...
                _mm256_store_pd(result.data,
                    _mm256_add_pd(av, _mm256_mul_pd(tv, _mm256_sub_pd(bv, av))));
                return result;
            #elif defined(__VECTOR_MATH_ARCH_ARM) && (defined(__arm64__) || defined(__aarch64__))
                Vector4d result;
